...
- Hardware (pins on the MCU, MAX7219 module varient, number of 8x8 modules) can be fconfigured via the web UI, no recompiling needed
- Display text from MQTT topics, Web API or Web UI
- Configuration via MQTT commands or a built-in Web GUI — no hardcoded credentials or filesystem upload required.
